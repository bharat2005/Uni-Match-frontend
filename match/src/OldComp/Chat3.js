  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography
          variant="h6"
          sx={{ marginLeft: "15px", textAlign: "center", fontWeight: "bold" }}
        >
          {match.name}
        </Typography>
      </Box>
        ...
        {messages.map((msg, index) => (
          <Box
            ...
            sx={{
              display: "flex",
              justifyContent:
                msg.sender_reg_no === 12413923 ? "flex-end" : "flex-start",
              mb: 1,
              wordWrap: "break-word",
              whiteSpace: "normal",
            }}
          >
            <Box sx={{ display: "flex", alignItems: "flex-start" }}>
              <Box
                sx={{
                  backgroundColor:
                    msg.sender_reg_no === 12413923 ? "black" : "darkgrey",
                  color: "white",
                  padding: "10px 15px",
                  borderRadius: "15px",
                  maxWidth: "75%",
