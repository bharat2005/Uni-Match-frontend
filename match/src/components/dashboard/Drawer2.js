  ...
  >
    ...
    <Box sx={{ mb: 1.25 }}>
      ...
      <Box sx={{ display: "flex", gap: 1, flexWrap: "wrap" }}>
        ...
        <Chip
          icon={
            profile.personality === "extrovert"
              ? <i className="ti ti-sun-filled" style={{ fontSize: "18px", color: 'white'}} />
              : profile.personality === "introvert"
                ? <i className="ti ti-moon-filled" style={{ fontSize: "18px", color: 'white'}} />
                : <i className="ti ti-seedling-filled" style={{ fontSize: "18px", color: 'white'}} />
          }
          label={
            profile.personality === "extrovert"
              ? "Extrovert"
        ...
        <Chip
          icon={<i className="ti ti-user-filled" style={{ fontSize: "18px", color:'white' }} />}
        ...
        {profile.reg_no === "12413923" && (
          <Chip
            icon={<i className="ti ti-settings" style={{ fontSize: "18px", color:'white' }} />}
            label="Developer"
            sx={{
              bgcolor: "#6A0DAD",
              color: "white",
