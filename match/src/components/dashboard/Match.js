...
<Button 
  ...
  onClick={() => swipe("left")}
  sx={{
    background: "linear-gradient(145deg, #FF006E 0%, #FB5607 50%, #FFBE0B 100%)", // More vibrant gradient
    borderRadius: "50%",
    width: "100px",
    height: "100px",
...
<Button 
  ...
  onClick={() => swipe("right")}
  sx={{
    background: "linear-gradient(145deg, #00C853 0%, #B2FF59 50%, #FFD600 100%)", // Vibrant green to lime to yellow
    borderRadius: "50%",
    width: "100px",
    height: "100px",
