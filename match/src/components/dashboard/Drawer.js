...
import {
  ...
  IconButton,
  Avatar,
  Button, // Added for controlling the drawer manually
  ThemeProvider,
  createTheme,
} from "@mui/material";
import {
...
function AppContainer({imageClick}) {
  // State to manage drawer open/close
 // Default to closed

  // Handle opening/closing of drawer with button
  // const toggleDrawer = () => {
  ...
  return (
      ...
      <Paper
        ...
        sx={{
          ...
          transform: imageClick ? "translate3d(0, 0, 0)" : "translate3d(0, 98%, 0)", // Drawer animation
