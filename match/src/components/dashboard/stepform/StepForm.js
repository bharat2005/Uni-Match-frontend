  ...
  return (
    <>
      ...
      <Box sx={styles.appContainer} >
        ...
        <Button onClick={() => {setStep(prev=> prev-1)}} sx={styles.backButton}>
          <ChevronLeftIcon  style={{fontSize:'28px'}}/>
        </Button>

                     {step === 0 && <Name setStep={setStep} formData={formData} setFormData={setFormData} />}
                     {step === 1 && <Gender setStep={setStep} formData={formData} setFormData={setFormData} />}
                     {step === 2 && <Age setStep={setStep} formData={formData} setFormData={setFormData} />}
                     {step === 3 && <Images images={images} setImages={setImages} setStep={setStep} formData={formData} setFormData={setFormData}/>}
                     {step === 4 && <Reasonnn setStep={setStep} formData={formData} setFormData={setFormData} />}
                     {step === 5 && <Bio setStep={setStep} formData={formData} setFormData={setFormData} />}
                     {step === 6 && <Interestt setStep={setStep} formData={formData} setFormData={setFormData} />}
                     {step === 7 && <Persona  handleDone={handleDone} formData={formData} setFormData={setFormData} />}
