...
export default function ImagePart({imageLoaded, setImageLoaded,  list, currentImageIndex, setImageClick, prevImage, nextImage} ){
  ...
  {list.map((_, index) => (
    <Box
      ...
      sx={{
        ...
        transform: index === currentImageIndex ? 'scale(1.1)' : 'scale(1)', // Gentle size bump for active
      }}
    />
  ))}
</Box>
